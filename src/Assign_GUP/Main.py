...
The GUI part of this file is editable by BoaConstructor.
Try to keep it that way for now.
'''
...
# for the About... box
__version__ = "$Revision: 2137 $"
__progname__ = "assign_gup"
__copyright__ = "(c) 2011-2015"
__license__ = ""
__long_description__ = '''
Help assigning APS SAXS General User Proposals
$Id: Main.py 2137 2015-03-22 17:28:19Z jemian $
'''
__URL__ = "$URL: http://svn.jemian.org/svn/regitte/assign_gup/src/Assign_GUP/Main.py $"
__website__ = ""
