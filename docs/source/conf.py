# -*- coding: utf-8 -*-
#
# Assign_GUP documentation build configuration file, created by
...
versioneer_version = Assign_GUP.__version__.split('+')
...
htmlhelp_basename = 'Assign_GUPdoc'
...
latex_documents = [
  ('index', 'Assign_GUP.tex', u'Assign\\_GUP Documentation',
   u'Pete R. Jemian', 'manual'),
]
...
man_pages = [
    ('index', 'assign_gup', u'Assign_GUP Documentation',
     [u'Pete R. Jemian'], 1)
]
